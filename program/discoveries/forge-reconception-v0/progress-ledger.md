...
No review corrections at initial authoring.
...
- **Decision A:** issue comment `#issuecomment-4979981162`
- **Decision B:** issue comment `#issuecomment-4985875797`
...
| #31 Decision A | comment `4979981162`; created/updated `2026-07-15T11:24:19Z` | `efc76534163d02efcbabff7e0b3273f7f75ff93f414174ebf65e969a78b667ee` | Human approval of the specification, without D1 activation |
| #31 Decision B | comment `4985875797`; created/updated `2026-07-15T22:26:40Z` | `b73e3cbd58417e2addab2bd016012709dee260684a5dcc5fd3dfa2a727b69f86` | Human activation of D1 under the approved specification |
| #31 verification record | comment `4985475981`; created/updated `2026-07-15T21:33:39Z` | `1faf81b42fabb4ceb73e50c653f1d28eabcd3021af859cb06e1722cc6891925a` | Verification of Decision A and proposal hash; explicitly did not activate D1 |
...
| #15 R2 parking decision | comment `4973558381`; created/updated `2026-07-14T20:13:40Z` | `d5c6a529ec9bfa0c85660eb8cb27bd24fe75a5fd6785d63ea37f30e2f769889a` | Human authority for the continuing R2 parking state |
...
| Current-state registry | TIBER-Ops `registry/tiber-current-state.v0.json` at `530b4fb...`; last source change `73530e3...` | `de531ecb36176c8b5c858f6927d18eadfc8efcfe6d325fe449789faf35f8d88e` | Promoted dependency, policy, supersession, and fail-closed pins |
...
|---|---|---|---|---|---|
| `docs/capabilities/README.md` @ `4920847...`; SHA-256 `c4993f4642cdeaa68f18a180cf92109ff73cc1e4d4f277210a05fa91ef9163ac` | `canonical_repo_documentation` | linked current capability index; last change `00336f3...` | The repository's governed player-history capability entry point | A future FORGE mission or ownership decision | `none_found` |
| `docs/capabilities/player-history-production-only-v0.md` @ `4920847...`; SHA-256 `0908180e3889d852b623039ebb79f4ee590f85b62bfb40581fbdf08cd3c9ef37` | `canonical_repo_documentation` | linked from current capability index; last change `00336f3...` | Production-only player-history evidence path and constraints | Approval of a new cross-repo architecture | `none_found` |
...
| `src/contracts/forge.ts` @ `af2ca4d...`; SHA-256 `ceeb45ee9833166d1192b25919b9b3ee24612f38af8a39ecea638656a45689a5` | `promoted_contract` | current-state registry active dependency | Current exported FORGE contract surface | Ownership doctrine or desired redesign | `none_found` |
| `src/contracts/football.ts` @ `af2ca4d...`; SHA-256 `453693f1bd069326b4266ed3346443bdee729a109face215c8d8a3c7f8adc68d` | `promoted_contract` | current-state registry active dependency | Current football-domain contract surface | Future mission or implementation mandate | `none_found` |
...
| `exports/promoted/forge_player_static/forge_player_static_v1.json` @ `af2ca4d...`; SHA-256 `2020a52b2e941fbcd7a78130399380351da914959663ff9f1abf15affece1041` | `promoted_contract` | current-state registry promoted artifact | Current promoted producer artifact and its actual shape | Architectural intent or consumer freshness | `none_found` |
...
| `server/contracts/rankingsV2.ts` @ `d35d440...`; SHA-256 `af7f56ffdb578254438c52c56dfd482d164d1fa42f415c2b7b00518322729c39` | `promoted_contract` | current-state registry active dependency | Current rankings-v2 contract | FORGE mission, grading doctrine, or implementation mandate | `none_found` |
...
- Architectural-evidence inventory: **complete for the named sources plus
  three confirmed current Forecast documents**.
...
`d1_evidence_complete_pending_independent_verification`

D1 evidence is ready for a fresh-context independent verifier. Until that
